...
rotator U0 (clk,rst,x[0],y[0],z[0],x[0+1],y[0+1],z[0+1]);
defparam U0.iteration = 0;
defparam U0.tangle = tanangle(0);

rotator U1 (clk,rst,x[1],y[1],z[1],x[1+1],y[1+1],z[1+1]);
defparam U1.iteration = 1;
defparam U1.tangle = tanangle(1);

rotator U2 (clk,rst,x[2],y[2],z[2],x[2+1],y[2+1],z[2+1]);
defparam U2.iteration = 2;
defparam U2.tangle = tanangle(2);

rotator U3 (clk,rst,x[3],y[3],z[3],x[3+1],y[3+1],z[3+1]);
defparam U3.iteration = 3;
defparam U3.tangle = tanangle(3);

rotator U4 (clk,rst,x[4],y[4],z[4],x[4+1],y[4+1],z[4+1]);
defparam U4.iteration = 4;
defparam U4.tangle = tanangle(4);

rotator U5 (clk,rst,x[5],y[5],z[5],x[5+1],y[5+1],z[5+1]);
defparam U5.iteration = 5;
defparam U5.tangle = tanangle(5);

rotator U6 (clk,rst,x[6],y[6],z[6],x[6+1],y[6+1],z[6+1]);
defparam U6.iteration = 6;
defparam U6.tangle = tanangle(6);

rotator U7 (clk,rst,x[7],y[7],z[7],x[7+1],y[7+1],z[7+1]);
